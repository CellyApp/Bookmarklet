...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.is_multiple) {
//**************************************** Modification here***********************************************************************************
        this.container.html('<ul class="chzn-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;height:30px;" /></li></ul><div class="chzn-drop"><ul class="chzn-results"></ul></div>');
      } else {
